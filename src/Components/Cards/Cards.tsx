...
const [selectedCards,setSelectedCards]=useState<Icards[]>([])
    return (
         ...
         <div className="grid grid-cols-12 gap-2 py-6 items-start pl-4">
             <div className="grid gap-2 grid-cols-1  md:grid-cols-3 col-span-12 md:col-span-9 ">
        ...
        onSelect={(card)=>{
         ...
         <div className="col-span-12 md:col-span-3 border border-slate-300 shadow-sm rounded-md flex flex-col items-center ">
